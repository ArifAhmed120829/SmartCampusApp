...
import com.example.myapp1.db.DatabaseHelper;
import com.example.myapp1.db.entity.Contact;
import com.example.myapp1.adapter.ContactsAdapter;
...
public class ContactActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contactsAdapter = new ContactsAdapter(this, contactArrayList,ContactActivity.this);
    ...
    public void addAndEditContacts(final boolean isUpdated,final Contact contact,final int position) {
        ...
        AlertDialog.Builder alerDialogBuilder = new AlertDialog.Builder(ContactActivity.this);
        ...
        alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (TextUtils.isEmpty(newContact.getText().toString())){
                    Toast.makeText(ContactActivity.this, "Please Enter a Name", Toast.LENGTH_SHORT).show();
